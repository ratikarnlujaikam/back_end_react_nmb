...
router.get("/LARPP", async (req, res) => {
  try {
    ...
    with set1 as (
      select 
	  substring([Line],0,5) as Line,[Line] as Line_NAME
    ...
    , case 
  when set2.Line  = '2-10'  then '2.6' 
	when set2.Line  = '2-12'  then '2.7'
	when set2.Line  = '2-13'  then '2.6'
  when set2.Line  = '2.14'  then '2.5'
  when set2.Line  = '3-17'  then '2.6'
  when set2.Line  = '3-22'  then '2.6'
  when set2.Line  = '3-24'  then '1.5'
  when set2.Line  = '3-26'  then '2.7'
  when set2.Line  = '2-9'  then '2.1'
  when set2.Line  = '3-30'  then '2.6'
  when set2.Line  = '2-14'  then '1.2'
  when set2.Line  = '1-4'  then '1.6'
  when set2.Line  = '3-10'  then '2.6'
  when set2.Line  = '1-10'  then '2.6'
  when set2.Line  = '2-6'  then '2.5'
  when set2.Line  = '3-6'  then '2.7'
	else  [NG] end as NG
	,Line_NAME from set2
